...
* Motivation
- Reproducing your configuration is trivial on a new machine is trivial via git
  clone
...
*** Git repositories
To install a git repository in STP, simply provide its URL as the remote.
*** GNU ELPA packages
